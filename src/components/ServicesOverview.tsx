      ...
      <div className="container-px">
        ...
        <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {list.map((service) => (
            ...
            >
              <span className="grid h-12 w-12 place-items-center rounded-lg bg-brand-500/15 text-brand-600 transition group-hover:bg-brand-500 group-hover:text-ink-950 dark:text-brand-400">
